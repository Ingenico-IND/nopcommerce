...
using Nop.Web.Models.emandateSi;
...
namespace Nop.Web.Controllers
{
    public class eMandateSiController : Controller
    {
        ...
        public eMandateSiController (IHostingEnvironment env)
        {
            _env = env;
        }
        ...
        [HttpPost]
        public ActionResult mandateVerification(IFormCollection fc)
        {
        ...
        [HttpPost]
        public ActionResult transactionVerification(IFormCollection fc)
        {
        ...
        public ActionResult transactionScheduling(IFormCollection fc)
        {
            //  string path = Server.MapPath("~/App_Data/");
            string path = _env.WebRootPath;
            string json = "";
        ...
        [HttpPost]
        public ActionResult stopPayment(IFormCollection fc)
        {
            //string path = Server.MapPath("~/App_Data/");
            string path = _env.WebRootPath;
            string json = "";
        ...
        [HttpPost]
        public ActionResult mandateDeactivation(IFormCollection fc)
        {
            string path = _env.WebRootPath;
            //string path = Server.MapPath("~/App_Data/");
            string json = "";
