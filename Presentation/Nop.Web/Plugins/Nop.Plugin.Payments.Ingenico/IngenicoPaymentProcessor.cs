...
namespace Nop.Plugin.Payments.PayPalStandard
{
    ...
    public class IngenicoPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        private readonly IngenicoStandardHttpClient _payPalStandardHttpClient;
        private readonly IngenicoPaymentSettings _payPalStandardPaymentSettings;
        ...
        public IngenicoPaymentProcessor(CurrencySettings currencySettings,
            ...
            IngenicoStandardHttpClient payPalStandardHttpClient,
            IngenicoPaymentSettings payPalStandardPaymentSettings)
        {
        ...
        private void AddItemsParameters(IDictionary<string, string> parameters, PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            _genericAttributeService.SaveAttribute(postProcessPaymentRequest.Order, IngenicoHelper.OrderTotalSentToPayPal, roundedCartTotal);
        }
        ...
        private void AddOrderTotalParameters(IDictionary<string, string> parameters, PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            //save order total that actually sent to PayPal (used for PDT order total validation)
            _genericAttributeService.SaveAttribute(postProcessPaymentRequest.Order, IngenicoHelper.OrderTotalSentToPayPal, roundedOrderTotal);
        }
