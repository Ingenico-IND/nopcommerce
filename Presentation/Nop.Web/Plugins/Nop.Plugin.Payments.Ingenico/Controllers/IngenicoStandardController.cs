...
{
    public class IngenicoStandardController : BasePaymentController
    {
        #region Fields
        ...
        public IngenicoStandardController(IGenericAttributeService genericAttributeService,
        ...
        public IActionResult Configure()
        {
            ...
            var payPalStandardPaymentSettings = _settingService.LoadSetting<IngenicoPaymentSettings>(storeScope);
